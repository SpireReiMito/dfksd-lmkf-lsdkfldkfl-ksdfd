...
getgenv().PredictionVelocity = 3.4 -- The speed of the PredictMovement feature 
        ...
        if Key.UserInputType == Enum.UserInputType.MouseButton2 then 
            pcall(function()
                ...
                if Target ~= nil then 
                    ...
                    Notify("FuckHood", "Aimlock Target: "..tostring(AimlockTarget), "", 3)
                end
            end)
        end
        if Key.KeyCode == Enum.KeyCode[AimlockToggleKey] then 
            Aimlock = not Aimlock
            Notify("FuckHood", "Aimlock: "..tostring(Aimlock), "", 3)
        end
    end
end)
...
SeparateNotify("FuckHood", "Universal Aimbot loaded in: "..string.format("%.7f", tostring(tick() - FuckHoodUniversalAimbotLoadingTime)), "", 3)
